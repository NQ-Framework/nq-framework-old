import { ActionInstance, Workflow, WorkflowExecutionContext } from '@nqframework/models';

export function loadFollowingActionsInChain(workflow: Workflow, actionInstance: ActionInstance, context: WorkflowExecutionContext) {
