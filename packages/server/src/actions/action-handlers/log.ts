import { ActionHandler, ActionInstance, ActionResult, PropertyValue, WorkflowExecutionContext } from '@nqframework/models';

export const handler: ActionHandler = {
    handle: async (inputValues: PropertyValue[], actionInstance: ActionInstance, workflowExecution: WorkflowExecutionContext): Promise<ActionResult> => {
