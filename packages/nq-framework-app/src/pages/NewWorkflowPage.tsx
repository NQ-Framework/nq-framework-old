                    ...
                    <Layout>
                        <GridItem rowSpan={2}>
                            <Grid templateColumns="1fr min(120ch, 100%) 1fr" >
                                <Box p={4} gridColumn={2} background="white" my={6} boxShadow="rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;" >
                                    <Formik
                                                ...
                                                <Field name="name" validate={validateName}>
                                                    {({ field, form }: any) => (
                                                        <FormControl isInvalid={form.errors.name && form.touched.name}>
                                                            <FormLabel htmlFor="name">Naziv workflowa</FormLabel>
                                                            <Input {...field} id="name" placeholder="Novi Workflow" />
