...
export const Layout: React.FC = (props: any) => {
  ...
  const { organization, organizations, setOrganization } = useContext(
    organizationContext,
  );
    ...
    >
      <GridItem background="white">
        ...
        >
          ...
          <Heading>
            {organization ? organization.name : 'nema organizacije'}
          </Heading>
          {!!user && (
            <Menu closeOnSelect={false}>
              ...
              <MenuList>
                ...
                >
                  {organizations.map((o) => (
                    <MenuItemOption key={o.name} value={o.name}>
                      {o.name}
                    </MenuItemOption>
                  ))}
                </MenuOptionGroup>
